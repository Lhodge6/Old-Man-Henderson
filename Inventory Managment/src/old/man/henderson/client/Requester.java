...
public class Requester{
	public static String sendMessage(String ip, int port, String msg, long requestTime, long timeOut)
	{
		...
		try{
			...
			if(System.currentTimeMillis() - timeOut < requestTime)
				sendMessage(ip, port, msg,requestTime, timeOut);
			else
