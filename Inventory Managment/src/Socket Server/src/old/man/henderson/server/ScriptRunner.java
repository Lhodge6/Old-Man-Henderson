...
public class ScriptRunner {
    ...
    private static boolean fullLineDelimiter = false;
    ...
    public static String runScriptWithResult(Connection conn, Reader reader) throws IOException,
    SQLException {
		StringBuffer command = null;
		ResultSet rs = null;
		String response = "";
